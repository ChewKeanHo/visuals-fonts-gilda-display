# Gilda Display Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Gilda Display is a Latin (ID: `*Latn`) Serif font designed by
[The Gilda Display Project Team](https://github.com/etunni/gilda-display). Its
design is based on a classic proportions, finest treatment of curves and strokes
of a standard Serif typeface.
...
headings, body text, and body footer text.
...
```
Title: Gilda Display Font
Creators: The Gilda Display Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-gilda-display
UUID: 9FEBF5A8-8FFA-4A47-BAE5-8C4327FA5055
License: SIL Open Font License (http://scripts.sil.org/OFL)
Repository Made On: 2026-04-18
Repository Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-fonts-gilda-display
```
